...
<div>
  ...
  <small><em>👤 Authors: Mots'oehli, Moseli</em></small><br>
  ...
  📝 Note: Survey. Review of assistive image annotation systems combining deep learning and natural language capabilities.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Zhuravlyov, A. K., et al.</em></small><br>
  <small><em>📍 Origin: Automatic Documentation and Mathematical Linguistics 58.Suppl 5 (2024)</em></small><br>
  📝 Note: Overview of machine learning methods for automatic annotation of training datasets in computer vision.
</div>
...
<div>
  ...
  <small><em>👤 Authors: Zhou, Shiyuan, et al.</em></small><br>
  <small><em>📍 Origin: Proceedings of the 30th International Conference on Intelligent User Interfaces (2025)</em></small><br>
  📝 Note: General application. Mixed-initiative labeling tool for specialized domains.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Adsule, Aniket, et al.</em></small><br>
  ...
  📝 Note: General application. Semi-supervised Siamese model with active learning for auto-labeling.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Toubal, Imad Eddine, et al.</em></small><br>
  <small><em>📍 Origin: Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (2024)</em></small><br>
  📝 Note: General application. LLM-assisted collaborative workflow to reduce human effort in subjective vision classification.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Vishwakarma, Harit, et al.</em></small><br>
  <small><em>📍 Origin: Advances in Neural Information Processing Systems 37 (2024)</em></small><br>
  📝 Note: General application. Improved confidence calibration for auto-labeling systems.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Zou, Xueyan, et al.</em></small><br>
...
<div>
  ...
  <small><em>👤 Authors: Zhou, Yijie, et al.</em></small><br>
  <small><em>📍 Origin: 2024 IEEE International Conference on Robotics and Automation (ICRA), IEEE (2024)</em></small><br>
  📝 Note: Multimodal application. Open-vocabulary auto-labeling system for multimodal 3D data.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Gallagher, James E., et al.</em></small><br>
  <small><em>📍 Origin: IEEE Access (2024)</em></small><br>
  📝 Note: Multimodal application. SAM-based transfer technique for machine-driven image labeling in multispectral settings.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Sun, Botao</em></small><br>
...
<div>
  ...
  <small><em>👤 Authors: Cazzaniga, Giorgio, et al.</em></small><br>
  <small><em>📍 Origin: Journal of Imaging Informatics in Medicine 38.2 (2025)</em></small><br>
  📝 Note: Medical application. Pilot study comparing manual and semi-automated annotation strategies in computational pathology.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Diaz-Pinto, Andres, et al.</em></small><br>
  <small><em>📍 Origin: Medical Image Analysis 95 (2024)</em></small><br>
  📝 Note: Medical application. AI-assisted interactive labeling framework for 3D medical images.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Deshpande, Tanvi, et al.</em></small><br>
  <small><em>📍 Origin: arXiv preprint arXiv:2404.17033 (2024)</em></small><br>
  📝 Note: Medical application. Weak-label generation from real and synthetic data for label-scarce medical image segmentation.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: He, Chunming, et al.</em></small><br>
  <small><em>📍 Origin: Advances in Neural Information Processing Systems 36 (2023)</em></small><br>
  📝 Note: Medical application. SAM-based pseudo-labeling strategy for weakly supervised object segmentation.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Kim, Doyun, et al.</em></small><br>
...
<div>
  ...
  <small><em>👤 Authors: Liang, Mingfu, et al.</em></small><br>
  <small><em>📍 Origin: Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (2024)</em></small><br>
  📝 Note: Autonomous driving application. Automatic data engine for object detection in autonomous driving.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Alamikkotervo, Eerik, et al.</em></small><br>
...
<div>
  ...
  <small><em>👤 Authors: Bist, Ramesh Bahadur, et al.</em></small><br>
  <small><em>📍 Origin: arXiv preprint arXiv:2501.10809 (2025)</em></small><br>
  📝 Note: Biological application. Ensemble-based auto-labeling for large-scale poultry datasets with self- and active-learning.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Yang, Chen, et al.</em></small><br>
  <small><em>📍 Origin: arXiv preprint arXiv:2403.18690 (2024)</em></small><br>
  📝 Note: Biological application. Annotation, segmentation, and tracking framework for biological image data.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Zurowietz, Martin, et al.</em></small><br>
...
<div>
  ...
  <small><em>👤 Authors: Zhang, Song, et al.</em></small><br>
  <small><em>📍 Origin: IEEE Transactions on Image Processing (2025)</em></small><br>
  📝 Note: Infrastructure monitoring application. Auto-labeling and pretraining scheme for remote sensing segmentation using Segment Anything Model.
</div>
<br>
<div>
  ...
  <small><em>👤 Authors: Schlonsak, Ruben, et al.</em></small><br>
...
<div>
  ...
  <small><em>👤 Authors: Matuzevičius, Dalius</em></small><br>
