...
- Zhifan Zhou - Carnegie Mellon University
[DataMaster: Towards Autonomous Data Engineering for Machine Learning](https://scholar.google.fr/citations?view_op=view_citation&hl=fr&user=tkpijsUAAAAJ&citation_for_view=tkpijsUAAAAJ:u5HHmVD_uO8C)
...
[Mixtera: A data plane for foundation model training](https://dl.acm.org/doi/pdf/10.1145/3786668)
[Modyn: Data-Centric Machine Learning Pipeline Orchestration](https://scholar.google.fr/citations?view_op=view_citation&hl=fr&user=i7jievkAAAAJ&cstart=20&pagesize=80&sortby=pubdate&citation_for_view=i7jievkAAAAJ:JV2RwH3_ST0C)

- Pınar Tözün - Copenhagen University
[Tensorsocket: Shared data loading for deep learning training](https://dl.acm.org/doi/abs/10.1145/3749185)
[Modyn: Data-centric machine learning pipeline orchestration](https://scholar.google.fr/citations?view_op=view_citation&hl=fr&user=JTmMb3kAAAAJ&sortby=pubdate&citation_for_view=JTmMb3kAAAAJ:f2IySw72cVMC)
[Data management and visualization for benchmarking deep learning training systems](https://dl.acm.org/doi/abs/10.1145/3595360.3595851)

- Yinglun Zhu - UC Riverside
[Labelbench: A comprehensive framework for benchmarking adaptive label-efficient learning](https://scholar.google.fr/citations?view_op=view_citation&hl=fr&user=9cboKEYAAAAJ&sortby=pubdate&citation_for_view=9cboKEYAAAAJ:ULOm3_A8WrAC)
