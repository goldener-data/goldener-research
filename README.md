...
and design their own research plan about it. Hopefully, heading to peer-reviewed publications.
...
a continuous written brainstorming session that can inspire new studies and features.

- Plans: Concrete research plans turning ideas into actionable experiments using Goldener. 
For instance, it can correspond to experiments already run by the Goldener community, wider project description
